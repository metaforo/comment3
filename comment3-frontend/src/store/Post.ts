    ...
    actions: {
        async submit({rootGetters}: { rootGetters: any }, data: FormData) {
            return await RequestMethods.post({
                route: import.meta.env.VITE_APP_GROUP_PATH + rootGetters.getGroupName + '/api/submit_post',
                data: data,
        ...
        async edit({rootGetters}: { rootGetters: any }, data: FormData) {
            return await RequestMethods.post({
                route: import.meta.env.VITE_APP_GROUP_PATH + rootGetters.getGroupName + '/api/edit_post',
                data: data,
            } as RequestOptionsInterface)
                .then((response) => {
        ...
        async delete({rootGetters}: { rootGetters: any }, data: FormData) {
            return await RequestMethods.post({
                route: import.meta.env.VITE_APP_GROUP_PATH + rootGetters.getGroupName + '/api/delete_post',
                data: data,
            } as RequestOptionsInterface)
                .then((response) => {
        ...
        async deleteAll({rootGetters}: { rootGetters: any }, data: FormData) {
            return await RequestMethods.post({
                route: import.meta.env.VITE_APP_GROUP_PATH + rootGetters.getGroupName + '/api/delete_all_post',
                data: data,
            } as RequestOptionsInterface)
                .then((response) => {
        ...
        async like({rootGetters}: { rootGetters: any }, data: FormData) {
            return await RequestMethods.post({
                route: import.meta.env.VITE_APP_GROUP_PATH + rootGetters.getGroupName + '/api/like_post',
                data: data,
            } as RequestOptionsInterface)
                .then((response) => {
        ...
        async unlike({rootGetters}: { rootGetters: any }, data: FormData) {
            return await RequestMethods.post({
                route: import.meta.env.VITE_APP_GROUP_PATH + rootGetters.getGroupName + '/api/unlike_post',
                data: data,
            } as RequestOptionsInterface)
                .then((response) => {
        ...
        async deleteByUser({rootGetters}: { rootGetters: any }, data: FormData) {
            return await RequestMethods.post({
                route: import.meta.env.VITE_APP_GROUP_PATH + rootGetters.getGroupName + '/api/delete_all_by_user',
                data: data,
            } as RequestOptionsInterface)
                .then((response) => {
        ...
        async undelete({rootGetters}: { rootGetters: any }, data: FormData) {
            return await RequestMethods.post({
                route: import.meta.env.VITE_APP_GROUP_PATH + rootGetters.getGroupName + '/api/un_delete_post',
                data: data,
            } as RequestOptionsInterface)
                .then((response) => {
